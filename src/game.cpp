...
//initialize the physics objects
    ...
    std::clog<<"object#"<<po2->number<<": "<<po2->name<<" initialized."<<std::endl;
    ...
    std::clog<<"object#"<<po3->number<<": "<<po3->name<<" initialized."<<std::endl;
    ...
    std::clog<<"object#"<<po4->number<<": "<<po4->name<<" initialized."<<std::endl;
