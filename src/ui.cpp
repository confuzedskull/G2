...
void ui::print_text()
{
    ...
    {
        sprintf(text10,"object touching side L:%d R:%d T:%d B:%d",game::rts_objects[cursor::selected_object]->touching[0], game::rts_objects[cursor::selected_object]->touching[1],
                 game::rts_objects[cursor::selected_object]->touching[2],game::rts_objects[cursor::selected_object]->touching[3]);
