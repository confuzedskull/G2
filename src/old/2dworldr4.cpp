...
//changelog
//fixed flickering HUD values
//fixed resting.y calculation
//delta_time increments at a more realistic rate: now it calculates seconds
//moved all the physics calculations from renderscene to physics method
//deleted some commmented out methods.
//replaced player action HUD value with velocity 2
